...
| 2 | NVIDIA64 + FP8 PRIMS (P×256) + Attention64 a 32K/64K/128K/256K | **Promovida a producción 2026-09-11.** Puerta ±5 pp pasa: 19/32 = 19/32, JSON 4/4, aceptación −0,78 pp, −0,46 GiB. TTFT −47/−47/−48/−50% a 32/64/128/256K; decode +4/+6/+16/+21%. 258K 133,5→67,3 s. Identidad de runtime: `5bpw-K8V4-MTP-NV64-PRIMS-ATT64` (perfil `flash` del servicio). Ver [resultados](2026-09-11-phase2-results.md). |
| 3 | Decode: XQA + KV NVFP4 en target, resolviendo antes el runtime de cola FP16 2K | **Siguiente.** Plan escrito 2026-09-14: [fase3-xqa-plan](2026-09-14-fase3-xqa-plan.md). Etapa A = port a la base NV64+PRIMS+ATT64 + puerta; Etapa B (cola FP16/LSE) solo si A falla en calidad. Verificado: XQA en FlashInfer 0.6.18 instalada sigue sin LSE. |
